...
import 'package:food_order/pages/waitScreen.dart';
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                CartItem(
                    ...
                    productCartQuantity:
                        "2"), //render food card items in my cart
                SizedBox(
                  height: 10,
                ),
                CartItem(
          ...
          child: InkWell(
            onTap: () {
              Navigator.of(context).push(MaterialPageRoute(
                  builder: (context) => WaitScreen())); //show user wait screen
            },
            child: Card(
              color: Colors.white,
              elevation: 0,
                ...
                child: Row(
                  children: <Widget>[
                    Container(
                      alignment: Alignment.center,
                      child: Image.asset(
                        "assets/images/menus/easypaisa.png", //render easy paisa image
                        width: 50,
                        height: 50,
                      ),
                    ),
              ...
              child: Row(
                children: <Widget>[
                  Container(
                    alignment: Alignment.center,
                    child: Image.asset(
                      "assets/images/menus/cash.png", //render by cash image
                      width: 50,
                      height: 50,
                    ),
                  ),
