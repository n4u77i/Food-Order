                ...
                child: Card(
                  ...
                  child: Image.asset(
                    'assets/images/bestfood/' +
                        imageUrl +
                        ".jpeg", //it will render the image of best food stored in assets folder
                    fit: BoxFit.cover,
                  ),
    ...
    return ListView(
      children: <Widget>[
        BestFoodTiles(
            ...
            slug:
                ""),
        // it will create a container of best food items with the following data given as an aruguments to this class
        BestFoodTiles(
            name: "Salad",
